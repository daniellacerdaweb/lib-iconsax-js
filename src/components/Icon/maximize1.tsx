export const IconMaximize1 = (props: any) => {
  return (
    <svg
      {...props}
      width="24"
    ...
    >
      ...
      />
      <path
        d="M18 14.75C17.59 14.75 17.25 14.41 17.25 14V12.75H6.75V14C6.75 14.41 6.41 14.75 6 14.75C5.59 14.75 5.25 14.41 5.25 14V10C5.25 9.59 5.59 9.25 6 9.25C6.41 9.25 6.75 9.59 6.75 10V11.25H17.25V10C17.25 9.59 17.59 9.25 18 9.25C18.41 9.25 18.75 9.59 18.75 10V14C18.75 14.41 18.41 14.75 18 14.75Z"
        fill="currentColor"
      />
      <path
        d="M14 18.75H10C9.59 18.75 9.25 18.41 9.25 18C9.25 17.59 9.59 17.25 10 17.25H11.25V6.75H10C9.59 6.75 9.25 6.41 9.25 6C9.25 5.59 9.59 5.25 10 5.25H14C14.41 5.25 14.75 5.59 14.75 6C14.75 6.41 14.41 6.75 14 6.75H12.75V17.25H14C14.41 17.25 14.75 17.59 14.75 18C14.75 18.41 14.41 18.75 14 18.75Z"
        fill="currentColor"
      />
    </svg>
  )
