...
export const ListIcons = () => {
  ...
  const copySvgFile = (data: any) => {
    const svgData = data.name;
  ...
  return (
    ...
    <Box sx={{ my:2}} >
          <input
            ...
            placeholder="Buscar:"
            value={searchTerm}
            style={{minWidth:'calc(100% - 13px)', height: "40px", borderRadius:'16px', paddingLeft:'10px', border:'1px solid #c0c0c0'  }}
