export const IconAlignRight = (props: any) => {
  return (
    <svg
      {...props}
      width="24"
    ...
    >
      ...
      />
      <path
        d="M19 22.7402C18.59 22.7402 18.25 22.4002 18.25 21.9902V1.99023C18.25 1.58023 18.59 1.24023 19 1.24023C19.41 1.24023 19.75 1.58023 19.75 1.99023V21.9902C19.75 22.4002 19.41 22.7402 19 22.7402Z"
        fill="currentColor"
      />
    </svg>
  )
